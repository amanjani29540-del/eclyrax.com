        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <p
              ...
              style={{ color: 'var(--color-muted-foreground)', opacity: 0.85 }}
            >
              eclyraX is built on a multi-layered architecture that ensures security, scalability,
            ...
            <p
              ...
              style={{ color: 'var(--color-muted-foreground)', opacity: 0.85 }}
            >
              Our infrastructure leverages distributed systems, redundant failovers, and real-time
              monitoring to deliver 99.99% uptime.
            </p>
          </section>
          ...
          <section>
            ...
            <p
              ...
              style={{ color: 'var(--color-muted-foreground)', opacity: 0.85 }}
            >
              Our architecture is designed to handle institutional-scale transaction volumes with
              sub-second latency. Horizontal scaling ensures seamless growth as your operations
              expand.
            </p>
          </section>
        </div>
