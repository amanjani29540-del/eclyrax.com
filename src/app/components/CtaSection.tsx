    ...
    >
      ...
      >
        <div className="marquee-container">
          {[0, 1]?.map((trackIdx) => (
            <div key={`track-${trackIdx}`} className="marquee-track gap-16" aria-hidden={trackIdx === 1}>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-24 md:py-40">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-20 items-center">
          ...
          <div className="col-span-1 md:col-span-7">
            <span className="section-label reveal block mb-8" style={{ fontWeight: 500, letterSpacing: "0.1em" }}>05 / ACCESS</span>
            <h2
              className="tracking-tight leading-tight reveal reveal-delay-1 mb-6"
              style={{ fontSize: "clamp(36px, 5.5vw, 72px)", color: "var(--color-foreground)", fontWeight: 600, letterSpacing: "-0.01em", lineHeight: "1.15" }}
            >
            ...
            >
              <span style={{ fontWeight: 500, letterSpacing: '0.005em' }}>eclyra</span><span style={{ fontWeight: 600, color: "#4A90E2" }}>X</span> is deployed as a controlled financial infrastructure layer for platforms requiring deterministic state, ledger integrity, and compliance-gated execution.
            ...
            >
              {[
                ...
                <div key={trust?.id} className="flex items-center gap-2">
                  <span style={{ color: "var(--color-primary)", fontSize: "12px" }}>{trust?.icon}</span>
                  <span
          ...
          <div className="col-span-1 md:col-span-5 reveal reveal-delay-2">
            ...
            >
              ...
              <div className="p-6 space-y-3">
                ...
                <p className="text-xs leading-relaxed" style={{ color: "var(--color-foreground)", fontWeight: 400 }}>
                  $ <span style={{ fontWeight: 500, letterSpacing: '0.005em' }}>eclyra</span><span style={{ fontWeight: 600, color: "#4A90E2" }}>X</span> bootstrap --mode=production
                </p>
                {[
                  { id: "cmd-2", text: "→ Attaching governed control layer...", color: "var(--color-muted-foreground)" },
                  { id: "cmd-3", text: "→ Enforcing transaction lifecycle discipline...", color: "var(--color-muted-foreground)" },
                  ...
                  { id: "cmd-9", text: "System integrity confirmed.", color: "var(--color-foreground)" },
                ]?.map((line) => (
                  <p
                    key={line?.id}
                ...
                <div
                  ...
                  style={{ background: "var(--color-primary)", animation: "fadeIn 1s steps(1) infinite alternate" }}
                />
              </div>
            </div>
