          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div className="col-span-1 md:col-span-11">
              ...
              >
                ...
                maintains structured architectural and operational documentation governing
                infrastructure behavior, execution controls, and financial state integrity.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div className="col-span-1 md:col-span-11">
              ...
              <p
                ...
                style={{ color: 'var(--color-muted-foreground)' }}
              >
                Architecture and control documentation is available through structured governance
                review channels. Access is granted based on operational relevance and control
                alignment.
              </p>
            </div>
          </div>
