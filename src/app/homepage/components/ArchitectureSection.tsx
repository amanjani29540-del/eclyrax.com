      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-16 md:mb-24">
          <div className="col-span-1 md:col-span-1">
            <span className="section-label reveal" style={{ fontWeight: 500, letterSpacing: "0.1em" }}>01 / ARCH</span>
          </div>
          <div className="col-span-1 md:col-span-7">
            <h2
              className="tracking-tight leading-tight reveal reveal-delay-1"
              style={{ fontSize: "clamp(36px, 5vw, 64px)", color: "var(--color-foreground)", fontWeight: 600, letterSpacing: "-0.01em", lineHeight: "1.15" }}
            >
          ...
          <div className="col-span-1 md:col-span-4 flex items-end">
            ...
            >
              <span style={{ fontWeight: 500, letterSpacing: '0.005em' }}>eclyra</span><span style={{ fontWeight: 600, color: "#4A90E2" }}>X</span> enforces ledger integrity, state-controlled execution, and compliance-gated commitment at the system layer. Financial correctness is structural — not assumed.
            </p>
          </div>
        </div>
