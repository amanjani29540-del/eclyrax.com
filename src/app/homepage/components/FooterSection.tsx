    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center">
            <span className="text-xl font-bold" style={{ color: 'var(--color-foreground)' }}>
              ...
              <span style={{ fontWeight: 600, color: '#4A90E2' }}>X</span>
            </span>
          </div>
        ...
        <div className="mt-8 text-center">
          <span className="text-xs" style={{ color: 'rgba(122,134,150,0.4)', fontWeight: 400 }}>
            © 2026 <span style={{ fontWeight: 500, letterSpacing: '0.005em' }}>eclyra</span>
            <span style={{ fontWeight: 600, color: '#4A90E2' }}>X</span>. All rights reserved.
          </span>
        </div>
      </div>
    </footer>
