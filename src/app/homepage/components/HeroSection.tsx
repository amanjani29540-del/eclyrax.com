    ...
    >
      ...
      >
        ...
        <div
          className="absolute inset-0 z-10 pointer-events-none"
          style={{
            background: 'linear-gradient(to right, rgba(8,12,16,0) 60%, #080C10 100%)',
          }}
        />
        ...
        <div className="absolute top-8 left-8 md:top-12 md:left-12 z-20">
          <span
            className="section-label opacity-40"
        ...
        <div className="absolute bottom-0 left-0 p-8 md:p-16 w-full z-20">
          ...
          {/* Headline */}
          <h1
            className={`tracking-tight leading-none mb-6 ${titleRevealed ? 'reveal-active' : ''}`}
            suppressHydrationWarning
            style={{
          ...
          >
            <span className="text-reveal-wrapper block">
              <span className="text-reveal-content">Financial Control Infrastructure.</span>
            </span>
            <span
              className="text-reveal-wrapper block"
              style={{ color: '#5A9FE5', fontSize: '0.65em', fontWeight: 400, opacity: 0.9 }}
            >
              <span className="text-reveal-content" style={{ transitionDelay: '120ms' }}>
          ...
          {/* Sub */}
          <p
            className="reveal reveal-delay-3 max-w-lg text-base md:text-lg leading-relaxed mb-8 active"
            style={{
              color: 'var(--color-muted-foreground)',
              fontWeight: 400,
              lineHeight: '1.6',
          ...
          >
            A governed financial control layer positioned between application logic and external
            financial rails.
          </p>

          {/* CTAs */}
          <div className="reveal reveal-delay-4 flex flex-wrap gap-4 active">
            <button
      ...
      >
        {sideStats.map((stat, idx) => (
          <div
            key={stat.id}
            className={`flex-shrink-0 w-[66.67%] md:w-auto md:flex-1 p-6 md:p-8 flex flex-col justify-center reveal reveal-delay-${idx + 2} active snap-start`}
            style={{
              borderBottom: 'none',
