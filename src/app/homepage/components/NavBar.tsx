...
export default function NavBar() {
  ...
  return (
    <>
      <AccessInfrastructureModal isOpen={accessModalOpen} onClose={() => setAccessModalOpen(false)} />
      ...
      <header
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between h-full">
          ...
          <div className="flex items-center">
            <span className="text-xl" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 500, letterSpacing: '0.005em', color: "var(--color-foreground)" }}>
