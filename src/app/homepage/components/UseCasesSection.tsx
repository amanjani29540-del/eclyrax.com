      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-16">
          <div className="col-span-1 md:col-span-1">
            <span className="section-label reveal" style={{ fontWeight: 500, letterSpacing: "0.1em" }}>03 / DEPLOY</span>
          </div>
          ...
          <div className="col-span-1 md:col-span-4 flex items-end">
            ...
            >
              <span style={{ fontWeight: 500, letterSpacing: '0.005em' }}>eclyra</span><span style={{ fontWeight: 600, color: "#4A90E2" }}>X</span> defines the financial control layer between application logic and external financial rails. Every transaction follows deterministic state, enforced compliance, and immutable ledger discipline.
            </p>
          </div>
        </div>
            ...
            <div className="p-8 md:p-10 h-full flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="relative z-10">
                <span
                  ...
                  style={{ color: useCases?.[0]?.accent, opacity: 0.8, fontWeight: 500, letterSpacing: "0.1em" }}
                >
                  {useCases?.[0]?.tag}
                </span>
                <h3
              ...
              <div className="p-6 md:p-7 h-full flex flex-col justify-between relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <span
                    ...
                    style={{ color: uc?.accent, opacity: 0.7, fontWeight: 500, letterSpacing: "0.1em" }}
                  >
                    {uc?.tag}
                  </span>
                  <h3
