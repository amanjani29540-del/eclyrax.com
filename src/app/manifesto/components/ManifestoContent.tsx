    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            <div className="col-span-1 md:col-span-1">
              <span className="section-label reveal" style={{ fontWeight: 500, letterSpacing: "0.1em" }}>01 / PRINCIPLE</span>
            </div>
            <div className="col-span-1 md:col-span-11">
              ...
              >
                <span style={{ fontFamily: 'Inter, sans-serif', fontWeight: 500, letterSpacing: '0.005em' }}>eclyra</span><span style={{ fontFamily: 'Inter, sans-serif', fontWeight: 600, color: "#4A90E2" }}>X</span> is designed on the premise that financial correctness must be enforced at the system layer — not observed after failure.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            <div className="col-span-1 md:col-span-1">
              <span className="section-label reveal" style={{ fontWeight: 500, letterSpacing: "0.1em" }}>02 / INTEGRITY</span>
            </div>
            <div className="col-span-1 md:col-span-11">
              <h2
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            <div className="col-span-1 md:col-span-1">
              <span className="section-label reveal" style={{ fontWeight: 500, letterSpacing: "0.1em" }}>03 / ACCOUNTABILITY</span>
            </div>
            <div className="col-span-1 md:col-span-11">
              <h2
                className="tracking-tight leading-tight reveal reveal-delay-1 mb-12"
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            <div className="col-span-1 md:col-span-1">
              <span className="section-label reveal" style={{ fontWeight: 500, letterSpacing: "0.1em" }}>05 / POSITION</span>
            </div>
            <div className="col-span-1 md:col-span-11">
              <h2
              ...
              <p
                ...
                style={{ color: "var(--color-muted-foreground)" }}
              >
                <span style={{ fontFamily: 'Inter, sans-serif', fontWeight: 500, letterSpacing: '0.005em' }}>eclyra</span><span style={{ fontFamily: 'Inter, sans-serif', fontWeight: 600, color: "#4A90E2" }}>X</span> is not positioned as an application layer product.
              </p>
              <p
                className="text-base md:text-lg leading-relaxed reveal reveal-delay-2 max-w-3xl"
                style={{ color: "var(--color-muted-foreground)" }}
              >
                It operates as a financial control substrate for platforms requiring deterministic execution and structural enforcement.
              </p>
            </div>
          </div>
        </div>
