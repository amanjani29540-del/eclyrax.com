        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <p
              ...
              style={{ color: 'var(--color-muted-foreground)', opacity: 0.85 }}
            >
              eclyraX maintains institutional-grade performance standards with continuous monitoring
              and optimization.
            </p>
          </section>
          ...
          <section>
            ...
            <p
              ...
              style={{ color: 'var(--color-muted-foreground)', opacity: 0.85 }}
            >
              All metrics are monitored in real-time with automated alerting and incident response.
              Detailed performance reports are available to institutional clients.
            </p>
          </section>
        </div>
      </div>
