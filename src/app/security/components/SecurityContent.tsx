          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div className="col-span-1 md:col-span-11">
              ...
              >
                ...
                enforces structured system integrity across infrastructure, execution layers, and
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div className="col-span-1 md:col-span-11">
              ...
              <p
                ...
                style={{ color: 'var(--color-muted-foreground)' }}
              >
                Security concerns may be submitted through official governance channels for
                structured review.
              </p>
            </div>
          </div>
